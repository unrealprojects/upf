...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Make from scss file -> css file
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////


static public function Make($Scss_File, $Css_File, $Format_Output = "scss_formatter_nested")
{
    // Scss Compiler
    $Compiler = new scssc();

    // Set Output Style
    $Compiler->setFormatter($Format_Output);

    // Set Base Path
    $Compiler->setImportPaths(dirname($Scss_File) . '/');

    // Get Scss File
    $Sass_File_Content = file_get_contents($Scss_File);

    // Get Scss File
    $Css = $Compiler->compile($Sass_File_Content);

    // Write Css
    \File::put($Css_File,$Css);
}
