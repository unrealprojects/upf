        ...
        <table class="Solid Lines Stripped Edit Adaptive">
            ...
            <tbody>
                @foreach($content['data']['list'] as $item)
                    <tr item-id="{{$item['id']}}" item-alias="{{$item['metadata']['alias']}}">
                        ...
                        @foreach($content['data']['fields'] as $alias => $field)
                            <td class="{{$field['class']}}">
                                @if($field['type']=='text')
                                    ...
                                    <div {{$field['editable']?'contenteditable="true"':''}} item-field="{{$alias}}">{{$item[$alias]}}</div>
                        ...
                        <td class="Actions">
                            ...
                            <ul>
                                ...
                                <li><a class="Item-Edit" title="Редактировать ..." href="{{$BaseUrl.$item['metadata']['alias'].'/edit'}}"><span class="fa fa-pencil"></span></a></li>
