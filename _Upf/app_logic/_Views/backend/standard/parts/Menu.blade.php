...
{{--            <li class="Menu-Subcategory-Item"><a class="Menu-Subcategory-Link" href="/backend/system/files"><span class="fa fa-image"></span>Файлы</a></li>         --}}
        ...
        <li class="Menu-Category-Item">
            <a class="Menu-Category-Link" href="#"><span class="fa fa-info"></span>Документация</a><span class="Menu-Category-Icon fa fa-angle-right"></span>
            <ul class="Menu-Subcategory">
                <li class="Menu-Subcategory-Item"><a class="Menu-Subcategory-Link" href="/backend/docs/cms"><span class="fa fa-cubes"></span>Upf CMS</a></li>
                <li class="Menu-Subcategory-Item"><a class="Menu-Subcategory-Link" href="/backend/docs/css"><span class="fa fa-css3"></span>Upf Css</a></li>
                <li class="Menu-Subcategory-Item"><a class="Menu-Subcategory-Link" href="/backend/docs/js"><span class="fa fa-fire"></span>Upf Js</a></li>
                <li class="Menu-Subcategory-Item"><a class="Menu-Subcategory-Link" href="http://laravel.com/docs"><span class="fa fa-compass"></span>Laravel</a></li>
            </ul>
        </li>

        <li class="Menu-Category-Item">
            <a class="Menu-Category-Link" href="#"><span class="fa fa-gears"></span>Тесты</a><span class="Menu-Category-Icon fa fa-angle-right"></span>
            <ul class="Menu-Subcategory">
                <li class="Menu-Subcategory-Item"><a class="Menu-Subcategory-Link" href="/backend/docs/testBackend"><span class="fa fa-backward"></span>Test Backend</a></li>
                <li class="Menu-Subcategory-Item"><a class="Menu-Subcategory-Link" href="/backend/docs/testFrontend"><span class="fa fa-forward"></span>Test Frontend</a></li>
                <li class="Menu-Subcategory-Item"><a class="Menu-Subcategory-Link" href="/backend/docs/test"><span class="fa fa-cube"></span>Тест</a></li>
            </ul>
        </li>
    </ul>
</aside>
